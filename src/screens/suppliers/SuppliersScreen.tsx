...
import { AllSuppliersPage } from './AllSuppliersPage.tsx';
...
export const SuppliersScreen: React.FC = () => {
  ...
  const handleAddClick = () => {
    NavigationService.navigate(ScreenId.ADD_SUPPLIER);
  };
  ...
  return (
    <BaseScreen scrollable={false} keyboardAware={false} style={{ flex: 1 }}>
      ...
      <PagerView
        ...
        <AllSuppliersPage filter={undefined} />
        <AllSuppliersPage filter={'active'} />
        <AllSuppliersPage filter={'inActive'} />
      </PagerView>
      <Button
