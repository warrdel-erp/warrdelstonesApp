...
import { AllCustomersPage } from './AllCustomersPage.tsx';
...
export const CustomersScreen: React.FC = () => {
  ...
  const handleAddClick = () => {
    NavigationService.navigate(ScreenId.ADD_CUSTOMERS);
  };
  ...
  return (
    <BaseScreen scrollable={false} keyboardAware={false} style={{ flex: 1 }}>
      ...
      <PagerView
        ...
        <AllCustomersPage filter={undefined} />
        <AllCustomersPage filter={'active'} />
        <AllCustomersPage filter={'inActive'} />
      </PagerView>
      <Button
