...
export interface ProductForInvoiceDetail {
    id: number;
    name: string;
    unitPrice: string;
    taxApplied: boolean;
...
export interface ProductsTableForInvoiceDetailProps {
    products: ProductForInvoiceDetail[];
    taxLabel: string;
}
...
const ProductsTableForInvoiceDetail: React.FC<ProductsTableForInvoiceDetailProps> = ({
    products,
    taxLabel,
}) => {
...
export default ProductsTableForInvoiceDetail;
